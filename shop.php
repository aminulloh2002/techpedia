            ...
            <div class="header-meta d-flex clearfix justify-content-end">
                ...
                <div class="search-area">
                    <form action="#" method="post">
                        <input type="search" name="keyword" id="keyword" placeholder="Type for search">
                        <button type="submit" name="search" id="tombol-cari"><i class="fa fa-search" aria-hidden="true"></i></button>
                    </form>
                </div>
                <!-- User Login Info -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-8 col-lg-12">
                    <div class="shop_grid_product_area" id="container" >
                        <div class="row">
                            <div class="col-12">
